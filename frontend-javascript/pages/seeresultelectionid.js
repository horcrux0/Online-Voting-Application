...
import Leftsidebarseeresultelectionid from "../components/Leftsidebarseeresultelectionid";
...
export default class SeeResultelectionId extends React.Component {
    ...
    render() {
        ...
        if (!this.state.result.length) {
            return (
                <div>
                    <Leftsidebarseeresultelectionid />
                    <div className={styles.card2}>No results Yet</div>;
                </div>
            );
        }
            ...
            <div>
                ...
                <div>
                    {this.state.result.map(r => (
                        <div className={styles.card222} key={r.Record.key}>

            ...
            <div className={styles.shadowbox5}>
                ...
                <Form {...layout} name="nest-messages" onFinish={onFinish} validateMessages={validateMessages}>
                    ...
                    <Form.Item wrapperCol={{...layout.wrapperCol, offset: 6}}>
                        <button className={styles.button55} type="primary" htmltype="submit" >
                            Submit
                        </button>
                    </Form.Item>
                    <Form.Item wrapperCol={{...layout.wrapperCol, offset: 18}}>
                        <div className={styles.shift1}>
                        <Button type="primary" icon={<CheckCircleFilled />} className={styles.button11} onClick={()=> router.push('/stopelection')}>
                            Complete
                        </Button>
                        </div>
                    </Form.Item>
